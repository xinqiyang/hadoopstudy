...
public class KPI {
    ...
    public static void main(String args[]) {
        String line = "124.155.55.165 - - [28/Aug/2016:02:27:22 +0000] \"GET /favicon.ico HTTP/1.1\" 200 16958 \"http://100intl.com/about\" \"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36\"";
        System.out.println(line);
        KPI kpi = new KPI();
        String[] arr = line.split(" ");
